...
namespace AcademiaTennisDAL.Migrations
{
    ...
    [Migration("20260809064027_AgregarReservaOrigenSolicitud")]
    partial class AgregarReservaOrigenSolicitud
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcademiaTennisDAL.Entities.GoogleCalendarToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AcademiaTennisDAL.Entities.SolicitudCurso", b =>
                {
                    ...
                    b.Property<int?>("IdReservaOrigen")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MonedaSolicitada")
                        .HasMaxLength(3)
                        .HasColumnType("varchar(3)");

                    b.Property<string>("MotivoRechazoAlumno")
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)");
                    ...
                    b.Property<decimal?>("PrecioSolicitado")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasIndex("IdReservaOrigen");

                    b.HasIndex("IdTarifaClase");
            ...
            modelBuilder.Entity("AcademiaTennisDAL.Entities.ZonaCobertura", b =>
                {
                    ...
                    b.Property<decimal?>("RadioMaximoKm")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("TarifaPorKm")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("AcademiaTennisDAL.Entities.SolicitudCurso", b =>
                {
                    ...
                    b.HasOne("AcademiaTennisDAL.Entities.Reserva", "ReservaOrigen")
                        .WithMany()
                        .HasForeignKey("IdReservaOrigen");

                    b.HasOne("AcademiaTennisDAL.Entities.TarifaClase", "TarifaClase")
                        .WithMany()
                        .HasForeignKey("IdTarifaClase");
                    ...
                    b.Navigation("ReservaOrigen");

                    b.Navigation("TarifaClase");
                });
