document.addEventListener("DOMContentLoaded", function () {
    ...
    const mapaElemento =
        document.getElementById("mapaSede");

    const latitudInput =
        document.getElementById("LatitudCentro");

    const longitudInput =
        document.getElementById("LongitudCentro");
    ...
    const formulario =
        document.getElementById("formZona");
        ...
        formulario.addEventListener(
            ...
            function (evento) {
                ...
                if (
                    ...
                    if (errorUbicacion) {
                        errorUbicacion.classList.remove(
                            "d-none"
                        );
                    }
